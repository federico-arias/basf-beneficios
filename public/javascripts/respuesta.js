...
},{"./Form.js":1,"js-cookie":6,"promise-polyfill":7}],3:[function(require,module,exports){
'use strict';
...
},{"highcharts":5}],4:[function(require,module,exports){
"use strict";
...
var _highchart = require('./modules/highchart.js');

var _fetch = require('./modules/fetch.js');

var _utils = require('./modules/utils.js');

var top5rechazo = new _highchart.Column('aprobacion-por-area', {
...
var top5demora = new _highchart.Column('top-5-respuesta', {
...
$("pais").onchange = function () {
	var demora = (0, _fetch.get)('/api/solicitud/demora');
	demora.then(paisF('BCW')).then(function (d) {
		return d.map(function (d) {
			return [d.beneficio, d.respuesta];
		});
	}).then(top5demora.update.bind(top5demora)).catch(_utils.log);

	var aprobacion = (0, _fetch.get)('/api/solicitud/aprobacion');
	aprobacion.then(paisF('BCW')).then(function (d) {
		return d.map(function (d) {
			return [d.beneficio, d.aprobacion];
		});
...
},{"./modules/fetch.js":2,"./modules/highchart.js":3,"./modules/utils.js":4}]},{},[8]);
