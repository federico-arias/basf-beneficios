...
var _utils = require('./modules/modules/utils.js');

var _fetch = require('./modules/fetch.js');

var _utils2 = require('./modules/utils.js');
...
var r = _interopRequireWildcard(_ramdaLens);
...
var data = (0, _fetch.get)('/api/colaborador/' + uid);
var allowed = ["colaborador", "telefono", "mail", "nacimiento_en", "run", "sucursal", "nacionalidad", "direccion", "cargo", "centro_costo", "supervisor_id"];
var p = (0, _dom.elem)('p');
...
data.then((0, _utils2.pick)(allowed)).then((0, _utils2.modify)('supervisor_id', (0, _utils2.prepend)('/colaborador/'))).then((0, _utils2.duplicate)('supervisor_id', 'supervisor')).then((0, _utils2.modify)('supervisor', function (_) {
	return 'Ver supervisor';
})).then((0, _utils2.merge)(['supervisor_id', 'supervisor'], _dom.href)).then((0, _utils2.bulkModify)(allowed.slice(0, -1).concat('supervisor'), p)).then(_dom.runWithKeys).catch(_utils2.log);

data.then(function (run) {
	(0, _utils.$)("colaborador-pic").src = "/assets/images/colaboradores/" + run.run + ".jpg";
}).catch(_utils2.log);
...
var keysBeneficios = ["beneficio", "solicitado_en", "estado", "monto"];
var tr = (0, _dom.elem)('tr');
var td = (0, _dom.elem)('td');

data.then((0, _lens.prop)(['json_agg'])).then((0, _utils2.map)((0, _utils2.pick)(keysBeneficios))).then((0, _utils2.map)((0, _utils2.modify)("monto", (0, _utils2.prepend)("$")))).then((0, _utils2.map)((0, _utils2.bulkModify)(keysBeneficios, td))).then((0, _utils2.map)((0, _dom.reduce)(keysBeneficios, tr))).then((0, _dom.runAll)('solicitudes')).catch(_utils2.log);
...
var keysCargas = ["carga", "nacido_en", "es_hijo"];

data.then((0, _lens.prop)(['cargas'])).then((0, _utils2.map)((0, _utils2.pick)(keysCargas))).then((0, _utils2.map)((0, _utils2.duplicate)("nacido_en", "edad"))).then((0, _utils2.map)((0, _utils2.modify)("edad", (0, _utils2.dateDiff)(Date.now())))).then((0, _utils2.map)((0, _utils2.modify)("es_hijo", (0, _utils2.ifTrueElse)('Hijo', 'Cónyuge')))).then((0, _utils2.map)((0, _utils2.bulkModify)(keysCargas.concat('edad'), td))).then((0, _utils2.map)((0, _dom.reduce)(keysCargas.concat('edad'), tr))).then((0, _dom.runAll)('cargas')).catch(_utils2.log);
...
(0, _utils.$)("btn-open-modal").addEventListener("click", function () {
	(0, _utils.$)("beneficio-modal").style.display = "inherit";
});

(0, _utils.$)("btn-close-modal").addEventListener("click", function () {
	(0, _utils.$)("beneficio-modal").style.display = "none";
});

(0, _utils.$)("btn-submit-modal").addEventListener("click", submit);
...
function populate() {
	var data = (0, _fetch.get)("/api/beneficios?individuales=true");
	var input = (0, _dom.typed)((0, _dom.elem)('input'));
	var option = (0, _dom.valued)((0, _dom.elem)('option'));
	var select = (0, _dom.named)((0, _dom.elem)('select'));
	var mergeOpt = function mergeOpt(value, name) {
		return option(value)(name);
	};

	data.then((0, _utils2.map)((0, _utils2.merge)(['id', 'beneficio'], mergeOpt))).then(function (arr) {
		//groupBy('beneficio')
		return arr.reduce(function (acc, o) {
			acc.appendChild(o.beneficio);
			return acc;
		}, document.createDocumentFragment());
	}).then(select('beneficio_id')).then((0, _dom.runAll)('beneficio_id-select')).then((0, _utils2.tap)(on('beneficio_id', 'change', change()))).catch(_utils2.log);
	...
	function change() {
		var div = (0, _dom.classed)((0, _dom.elem)('div'));
		var label = (0, _dom.elem)('label');
		var fecha = (0, _dom.attr)(input('text')); //not 'date' bc of ie11
		var number = (0, _dom.attr)(input('number'));
		var monto = { name: 'monto', placeholder: 'Ingresa el monto' };
		var resuelto = { name: 'resuelto_en', placeholder: 'Ingresa la fecha de resolucióń' };

		return function (ev) {
			var os = ev.target.options;
			var id = parseInt(os.item(os.selectedIndex).value);
			data.then((0, _utils2.tap)((0, _dom.clear)('dynamic-form'))).then((0, _utils2.where)('id', id)).then((0, _utils2.pick)(['es_costeable', 'es_aprobado'])).then((0, _utils2.rename)('es_costeable', 'monto')).then((0, _utils2.rename)('es_aprobado', 'resuelto_en')).then((0, _utils2.modify)('monto', number(monto))).then((0, _utils2.modify)('monto', div('col-md-12 dynamic-form'))).then((0, _utils2.modify)('resuelto_en', fecha(resuelto))).then((0, _utils2.modify)('resuelto_en', div('col-md-12 dynamic-form'))).then((0, _utils2.tap)(on('resuelto_en', 'change', pop))).then(_dom.runWithKeys).catch(_utils2.log);
		};
...
function submit(ev) {
	var solicitud = new _Form.Form(ev.target.form);
	solicitud.append('colaborador_id', uid, uid);
	var opts = {
		form: solicitud
	};
	var sent = (0, _fetch.put)('/api/solicitud', opts);
	var keys = ['beneficio_id', 'resuelto_en', 'monto'];

	sent.then((0, _utils2.pick)(keys)).then((0, _utils2.bulkModify)(keys, td)).then((0, _dom.reduce)(keys, tr)).then((0, _utils2.tap)((0, _dom.hide)(ev.target.form.parentElement.parentElement))).then((0, _dom.runAll)('solicitudes')).catch(_utils2.log);
}
...
},{"./modules/Form.js":2,"./modules/dom.js":3,"./modules/fetch.js":4,"./modules/lens.js":5,"./modules/modules/utils.js":6,"./modules/utils.js":7,"ramda-lens":10}],2:[function(require,module,exports){
'use strict';
...
},{"./src/folds":64,"./src/isos":68,"./src/lens":69,"./src/traversals":71,"ramda/src/mergeAll":48}],11:[function(require,module,exports){
...
},{"./internal/_curry1":23}],12:[function(require,module,exports){
...
},{"./curryN":16,"./internal/_concat":22,"./internal/_curry2":24,"./internal/_reduce":38,"./map":46}],13:[function(require,module,exports){
...
},{"./internal/_arity":19,"./internal/_curry2":24}],14:[function(require,module,exports){
...
},{"./pipe":53,"./reverse":57}],15:[function(require,module,exports){
var _curry1 = require('./internal/_curry1');
var curryN = require('./curryN');
...
},{"./curryN":16,"./internal/_curry1":23}],16:[function(require,module,exports){
var _arity = require('./internal/_arity');
var _curry1 = require('./internal/_curry1');
var _curry2 = require('./internal/_curry2');
...
},{"./internal/_arity":19,"./internal/_curry1":23,"./internal/_curry2":24,"./internal/_curryN":26}],17:[function(require,module,exports){
var _curry2 = require('./internal/_curry2');
...
},{"./internal/_curry2":24,"./internal/_equals":28}],18:[function(require,module,exports){
var _curry2 = require('./internal/_curry2');
...
},{"./internal/_curry2":24}],19:[function(require,module,exports){
...
},{"./_isArray":31,"./_slice":39}],22:[function(require,module,exports){
/**
...
},{"./_isPlaceholder":32}],24:[function(require,module,exports){
...
},{"./_curry1":23,"./_isPlaceholder":32}],25:[function(require,module,exports){
var _curry1 = require('./_curry1');
...
},{"./_curry1":23,"./_curry2":24,"./_isPlaceholder":32}],26:[function(require,module,exports){
...
},{"./_arity":19,"./_isPlaceholder":32}],27:[function(require,module,exports){
var _isArray = require('./_isArray');
...
},{"./_isArray":31,"./_isTransformer":34,"./_slice":39}],28:[function(require,module,exports){
...
},{"../identical":18,"../keys":44,"../type":63,"./_arrayFromIterator":20,"./_has":29}],29:[function(require,module,exports){
...
},{"../bind":13,"../isArrayLike":43,"./_xwrap":42}],39:[function(require,module,exports){
/**
...
},{"./_curry2":24,"./_xfBase":40}],42:[function(require,module,exports){
module.exports = (function() {
  function XWrap(fn) {
    this.f = fn;
  }
...
},{"./internal/_curry1":23,"./internal/_isArray":31}],44:[function(require,module,exports){
var _curry1 = require('./internal/_curry1');
...
},{"./internal/_curry1":23,"./internal/_has":29,"./internal/_isArguments":30}],45:[function(require,module,exports){
var _curry2 = require('./internal/_curry2');
var map = require('./map');
...
},{"./internal/_curry2":24,"./map":46}],46:[function(require,module,exports){
var _curry2 = require('./internal/_curry2');
...
},{"./curryN":16,"./internal/_curry2":24,"./internal/_dispatchable":27,"./internal/_map":35,"./internal/_reduce":38,"./internal/_xmap":41,"./keys":44}],47:[function(require,module,exports){
...
},{"./mergeWith":49}],48:[function(require,module,exports){
var _curry1 = require('./internal/_curry1');
...
},{"./internal/_curry1":23,"./merge":47,"./reduce":55}],49:[function(require,module,exports){
...
},{"./internal/_curry3":25,"./mergeWithKey":50}],50:[function(require,module,exports){
var _curry3 = require('./internal/_curry3');
var _has = require('./internal/_has');
...
},{"./internal/_curry3":25,"./internal/_has":29}],51:[function(require,module,exports){
var _curry1 = require('./internal/_curry1');
...
},{"./internal/_curry1":23,"./internal/_of":36}],52:[function(require,module,exports){
var _curry3 = require('./internal/_curry3');
...
},{"./internal/_curry3":25}],53:[function(require,module,exports){
var _arity = require('./internal/_arity');
...
},{"./internal/_arity":19,"./internal/_pipe":37,"./reduce":55,"./tail":61}],54:[function(require,module,exports){
var _concat = require('./internal/_concat');
var _curry2 = require('./internal/_curry2');
...
},{"./internal/_concat":22,"./internal/_curry2":24}],55:[function(require,module,exports){
var _curry3 = require('./internal/_curry3');
var _reduce = require('./internal/_reduce');
...
},{"./internal/_curry3":25,"./internal/_reduce":38}],56:[function(require,module,exports){
var _curry3 = require('./internal/_curry3');
...
},{"./internal/_curry3":25}],57:[function(require,module,exports){
var _curry1 = require('./internal/_curry1');
...
},{"./internal/_curry1":23,"./internal/_isString":33,"./internal/_slice":39}],58:[function(require,module,exports){
var _curry2 = require('./internal/_curry2');
var ap = require('./ap');
var map = require('./map');
...
},{"./ap":12,"./internal/_curry2":24,"./map":46,"./prepend":54,"./reduceRight":56}],59:[function(require,module,exports){
var _curry3 = require('./internal/_curry3');
...
},{"./always":11,"./internal/_curry3":25,"./over":52}],60:[function(require,module,exports){
...
},{"./internal/_checkForMethod":21,"./internal/_curry3":25}],61:[function(require,module,exports){
var _checkForMethod = require('./internal/_checkForMethod');
...
},{"./internal/_checkForMethod":21,"./slice":60}],62:[function(require,module,exports){
var _curry3 = require('./internal/_curry3');
var map = require('./map');
...
},{"./internal/_curry3":25,"./map":46,"./sequence":58}],63:[function(require,module,exports){
var _curry1 = require('./internal/_curry1');
...
},{"./internal/_curry1":23}],64:[function(require,module,exports){
...
},{"./internal/_const":65,"./internal/_monoids":67,"ramda/src/compose":14,"ramda/src/curry":15,"ramda/src/of":51}],65:[function(require,module,exports){
...
},{"ramda/src/equals":17}],67:[function(require,module,exports){
function Sum(x) {
  return {
    type: 'Sum',
    value: x,
...
},{"ramda/src/curry":15,"ramda/src/map":46}],69:[function(require,module,exports){
...
},{"./over":70,"./view":72,"ramda/src/lens":45,"ramda/src/set":59}],70:[function(require,module,exports){
var curry = require('ramda/src/curry')
...
},{"./internal/_identity":66,"ramda/src/curry":15}],71:[function(require,module,exports){
var curry = require('ramda/src/curry')
var compose = require('ramda/src/compose')
...
},{"./internal/_identity":66,"ramda/src/compose":14,"ramda/src/curry":15,"ramda/src/map":46,"ramda/src/traverse":62}],72:[function(require,module,exports){
var curry = require('ramda/src/curry')
...
},{"./internal/_const":65,"ramda/src/curry":15}]},{},[1]);
